 ...
 */
export async function addMessageToMainChat(text, isUser) {
  const context = getContext();

  // Format as a text message in the main chat
  ...
  console.log('[st-text-messaging] Added phone message to main chat:', isUser ? 'user' : 'character');
}
