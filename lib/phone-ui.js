...
import { addMessage, getMessages, getLastMessages, clearMessages, removeMessage, editMessage, restoreMessage, getMessageById } from "./message-store.js";
...
function setupMessageInteractionHandlers() {
  ...
  $(document).on('click.phoneMenu', function (e) {
